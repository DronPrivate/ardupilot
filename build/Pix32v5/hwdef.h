...
#define CHIBIOS_BOARD_NAME "Pix32v5"
...
#endif
#define HAL_SPI1_CONFIG { &SPID1, 1, STM32_SPI_SPI1_DMA_STREAMS, PAL_LINE(GPIOG,11U) }
...
{  0,  0,    3.30/4096 }, /* PA0 BATT_VOLTAGE_SENS */ \
{  1,  1,    3.30/4096 }, /* PA1 BATT_CURRENT_SENS */ \
{  2,  2,    3.30/4096 }, /* PA2 BATT2_VOLTAGE_SENS */ \
{  3,  3,    3.30/4096 }, /* PA3 BATT2_CURRENT_SENS */ \
{  4,  4,    3.30/4096 }, /* PA4 SPARE2_ADC1 */ \
{  8,  8,    3.30/4096 }, /* PB0 RSSI_IN */ \
{ 10, 10,  2*3.30/4096 }, /* PC0 VDD_5V_SENS */ \
{ 11, 11,  2*3.30/4096 }, /* PC1 SCALED_V3V3 */ \
{ 14, 14,    3.30/4096 }, /* PC4 SPARE1_ADC1 */ \
...
#define HAL_GPIO_PIN_VBUS_nVALID          PAL_LINE(GPIOG,3U)
...
// Note: The following peripherals can't be resolved for DMA: ['TIM4_UP', 'USART2_TX']
...
#define STM32_SPI_SPI2_TX_DMA_STREAM   STM32_DMA_STREAM_ID(1, 4) // shared SPI2_TX,USART3_TX
...
#define STM32_UART_USART3_TX_DMA_STREAM STM32_DMA_STREAM_ID(1, 4) // shared SPI2_TX,USART3_TX
...
#define HAL_CRASH_SERIAL_PORT USART3
#define IRQ_DISABLE_HAL_CRASH_SERIAL_PORT() nvicDisableVector(STM32_USART3_NUMBER)
#define RCC_RESET_HAL_CRASH_SERIAL_PORT() rccResetUSART3(); rccEnableUSART3(true)
#define HAL_CRASH_SERIAL_PORT_CLOCK STM32_USART3CLK
...
#define HAL_USART2_CONFIG { (BaseSequentialStream*) &SD2, 2, false, STM32_USART2_RX_DMA_CONFIG, STM32_USART2_TX_DMA_CONFIG, PAL_LINE(GPIOD,5U), PAL_LINE(GPIOD,6U), PAL_LINE(GPIOD,4U), PAL_LINE(GPIOD,3U), -1, 0, -1, 0, 0, 7}
#define HAL_HAVE_RTSCTS_SERIAL2
#define HAL_USART3_CONFIG { (BaseSequentialStream*) &SD3, 3, false, STM32_USART3_RX_DMA_CONFIG, STM32_USART3_TX_DMA_CONFIG, PAL_LINE(GPIOD,8U), PAL_LINE(GPIOD,9U), PAL_LINE(GPIOD,12U), PAL_LINE(GPIOD,11U), -1, 0, -1, 0, 0, 7}
...
#define HAL_UART4_CONFIG { (BaseSequentialStream*) &SD4, 4, false, STM32_UART4_RX_DMA_CONFIG, STM32_UART4_TX_DMA_CONFIG, PAL_LINE(GPIOD,1U), PAL_LINE(GPIOD,0U), 0, 0, -1, 0, -1, 0, 0, UINT8_MAX}
#define HAL_HAVE_RTSCTS_SERIAL5
#define HAL_USART6_CONFIG { (BaseSequentialStream*) &SD6, 6, false, STM32_USART6_RX_DMA_CONFIG, STM32_USART6_TX_DMA_CONFIG, PAL_LINE(GPIOG,14U), PAL_LINE(GPIOG,9U), PAL_LINE(GPIOG,8U), PAL_LINE(GPIOG,15U), -1, 0, -1, 0, 0, 8}
...
#endif
#define HAL_SERIAL_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART2_CONFIG,HAL_USART3_CONFIG,HAL_USART1_CONFIG,HAL_UART4_CONFIG,HAL_USART6_CONFIG,HAL_UART7_CONFIG,HAL_OTG2_CONFIG,HAL_UART8_CONFIG

#define HAL_UART_NUM_SERIAL_PORTS 8
// USB configuration
#define HAL_USB_VENDOR_ID 0x3162
#define HAL_USB_PRODUCT_ID 0x004e
